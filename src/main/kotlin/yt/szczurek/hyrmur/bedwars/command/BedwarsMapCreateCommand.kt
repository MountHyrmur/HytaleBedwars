...
class BedwarsMapCreateCommand : BedwarsMapActionCommand("create") {
    ...
    companion object {
        val MESSAGE_CREATE_START = Message.translation("server.commands.bedwars.map.create.createStart")
        val MESSAGE_CREATE_END = Message.translation("server.commands.bedwars.map.create.createEnd")
