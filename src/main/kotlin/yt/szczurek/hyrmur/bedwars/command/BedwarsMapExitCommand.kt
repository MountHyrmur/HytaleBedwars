...
private val MESSAGE_EXIT_SUCCESS = Message.translation("server.commands.bedwars.map.exit.success")
private val MESSAGE_WARN_NOT_VALID = Message.translation("server.commands.bedwars.map.exit.warnNotValid")
